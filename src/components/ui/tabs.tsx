...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 items-center justify-center gap-1 rounded-lg border border-white/10 bg-white/[0.03] p-1 text-muted-foreground backdrop-blur",
      className
    )}
    {...props}
  />
